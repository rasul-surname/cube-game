# Cube Game
Игра Шульте для увеличения периферического зрения которая способствует увеличению скорости чтения. Проект разработан в учебных целях, для тренировки навыков javascript`а.
...
## Список задач
- [x] Добавить README
- [x] Добавить cursor: pointer`ы
- [ ] Оптимизировать код
- [ ] Добавить возможность выбрать уровень
- [ ] Предложите своё?
